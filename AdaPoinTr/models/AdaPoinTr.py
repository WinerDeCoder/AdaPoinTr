...
class # The above code is defining a class called `SelfAttnBlockApi`.
SelfAttnBlockApi(nn.Module):
    r'''
...
class PCTransformer(nn.Module):
    ...
    def forward(self, xyz):
        ...
        # query selection    # chỗ ranking S query để chọn ra M query cuối cùng
